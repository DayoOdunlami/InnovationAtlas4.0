...
const PassportListCard = dynamic(
  () =>
    import("./tool-invocation/passport-list-card").then(
      (mod) => mod.PassportListCard,
    ),
  { ssr: false, loading },
);
...
export const ToolMessagePart = memo(
  ({
    ...
    const CustomToolComponent = useMemo(() => {
      ...
      if (toolName === DefaultToolName.ListPassports) {
        return <PassportListCard key={toolCallId} part={part} />;
      }
